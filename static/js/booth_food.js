document.addEventListener("DOMContentLoaded", function () {
    const boothData = {
        blue: [
    { id: "blue_1", name: "운영 및 안내부스", number: "1번", description: "운영 및 안내부스입니다." },
  { id: "blue_2", name: "운영 및 안내부스", number: "2번", description: "운영 및 안내부스입니다." },
  { id: "blue_3", name: "보건진료실", number: "3번", description: "보건진료실" },
  { id: "blue_4", name: "대외협력과", number: "4번", description: "대외협력과" },
  { id: "blue_5", name: "학생상담센터", number: "5번", description: "학생상담센터" },
  { id: "blue_6", name: "인권센터", number: "6번", description: "인권센터" },
  { id: "blue_7", name: "또굿집", number: "7번", description: "축제준비위원회" },
  { id: "blue_8", name: "과일을 찾아라!", number: "8번", description: "총학생회(서화)" },
  { id: "blue_9", name: "슬리퍼 발로 차", number: "9번", description: "총동아리연합회(결결)" },
  { id: "blue_10", name: "탁구공 던지기 게임", number: "10번", description: "그린스마트팜스쿨학생회(화랑)" },
  { id: "blue_11", name: "소원을 말해봐", number: "11번", description: "우주항공첨단소재스쿨학생회(SO:ONE)" },
  { id: "blue_12", name: "2025년 마약류 중독 및 오남용 예방 캠페인", number: "12번", description: "약학대학 학생회(도파민)" },
  { id: "blue_13", name: "월하랑 놀자", number: "13번", description: "애니메이션문화콘텐츠스쿨" },
  { id: "blue_14", name: "GTEP 사업단", number: "14번", description: "GTEP 사업단" },
  { id: "blue_15", name: "양말목 티코스터&음료 리필스테이션", number: "15번", description: "중앙 동아리(새순)" },
  { id: "blue_16", name: "취향을 담은 꾸러미", number: "16번", description: "창업동아리(방향을 잡는 사람들)" },
  { id: "blue_17", name: "디망쉬", number: "17번", description: "디망쉬" },
  { id: "blue_18", name: "농협", number: "18번", description: "농협" },
  { id: "blue_19", name: "동화 속 한 장면", number: "19번", description: "총학생회(서화)" },
  { id: "blue_20", name: "동화 속 한 장면", number: "20번", description: "총학생회(서화)" }
