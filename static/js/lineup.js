document.addEventListener("DOMContentLoaded", function () {
    const imageChanges = [
        {
            ...
            nextTime: new Date("2025-05-12T10:00:00").getTime()
        },
        {
            id: 'artist-image2',
    ...
    const albumChanges = [
        ...
        },
        {
            ...
            time: new Date("2025-05-12T10:00:00").getTime()  // 두 번째 앨범 변경 시간
        },
        {
            id: 'album3', // 1일차 1번
        ...
        },
        {
            ...
            time: new Date("2025-05-14T10:00:00").getTime()  // 첫 번째 앨범 변경 시간
        },
        {
            id: 'album11', // 2일차 1번
