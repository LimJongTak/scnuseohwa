...
def booth_detail(booth_id):
    ...
    "blue_11": {"name": "양말목 티코스터&음료 리필스테이션", "description": "중앙 동아리(새순)", "image_url": "/static/images/booth_blue.jpg"},
    "blue_12": {"name": "취향을 담은 꾸러미", "description": "창업동아리(방향을 잡는 사람들)", "image_url": "/static/images/booth_blue.jpg"},
    "blue_13": {"name": "디망쉬", "description": "디망쉬", "image_url": "/static/images/booth_blue.jpg"},
    "blue_14": {"name": "대학본부 1", "description": "대학본부 1", "image_url": "/static/images/booth_blue.jpg"},
    "blue_15": {"name": "대학본부 2", "description": "대학본부 2", "image_url": "/static/images/booth_blue.jpg"},
    "blue_16": {"name": "대학본부 3", "description": "대학본부 3", "image_url": "/static/images/booth_blue.jpg"},
    "blue_17": {"name": "대학본부 4", "description": "대학본부 4", "image_url": "/static/images/booth_blue.jpg"},
    "blue_18": {"name": "대학본부 5", "description": "대학본부 5", "image_url": "/static/images/booth_blue.jpg"},
    "blue_19": {"name": "대학본부 6", "description": "대학본부 6", "image_url": "/static/images/booth_blue.jpg"},
    "blue_20": {"name": "동화 속 한 장면", "description": "인생네컷", "image_url": "/static/images/booth_blue.jpg"},
    "blue_21": {"name": "동화 속 한 장면", "description": "인생네컷", "image_url": "/static/images/booth_blue.jpg"},
