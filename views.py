...
def booth_detail(booth_id):
    ...
    "blue_3": {"name": "또굿집", "description": "축제준비위원회"},
    "blue_4": {"name": "과일을 찾아라!", "description": "총학생회(서화)"},
    "blue_5": {"name": "슬리퍼 발로 차", "description": "총동아리연합회(결)"},
    "blue_6": {"name": "탁구공 던지기 게임", "description": "그린스마트팜스쿨학생회(화랑)"},
    "blue_7": {"name": "소원을 말해봐", "description": "우주항공첨단소재스쿨학생회(SO:ONE)"},
    "blue_8": {"name": "2025년 마약류 중독 및 오남용 예방 캠페인", "description": "약학대학 학생회(도파민)"},
    "blue_9": {"name": "월하랑 놀자", "description": "애니메이션문화콘텐츠스쿨"},
    "blue_10": {"name": "GTEP 사업단", "description": "GTEP 사업단"},
    "green_11": {"name": "양말목 티코스터&음료 리필스테이션", "description": "중앙 동아리(새순)"},
    "green_12": {"name": "취향을 담은 꾸러미", "description": "창업동아리(방향을 잡는 사람들)"},
    "green_13": {"name": "디망쉬", "description": "디망쉬"},
    "green_14": {"name": "대학본부 1", "description": "대학본부 1"},
    "green_15": {"name": "대학본부 2", "description": "대학본부 2"},
    "green_16": {"name": "대학본부 3", "description": "대학본부 3"},
    "green_17": {"name": "대학본부 4", "description": "대학본부 4"},
    "green_18": {"name": "대학본부 5", "description": "대학본부 5"},
    "green_19": {"name": "대학본부 6", "description": "대학본부 6"},
    "green_20": {"name": "동화 속 한 장면", "description": "인생네컷"},
    "green_21": {"name": "동화 속 한 장면", "description": "인생네컷"},
