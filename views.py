...
def booth_detail(booth_id):
    # 부스 데이터 예시
    booth_data = {
        "blue_1": {"name": "1번 부스", "description": "부스 1입니다.", "image_url": "/static/images/booth_blue.jpg"},
        "blue_2": {"name": "2번 부스", "description": "부스 2입니다.", "image_url": "/static/images/booth_blue.jpg"},
        ...
        "blue_11": {"name": "11번 부스", "description": "부스 11입니다.", "image_url": "/static/images/booth_blue.jpg"},
        ...
        "green_22": {"name": "22번 부스", "description": "부스 22입니다.", "image_url": "/static/images/booth_green.jpg"},
        ...
        "food_16": {"name": "푸드트럭 16", "description": "추후 안내해 드리겠습니다.", "image_url": "/static/images/hotdog.jpg"},
        "food_17": {"name": "푸드트럭 17", "description": "추후 안내해 드리겠습니다.", "image_url": "/static/images/hotdog.jpg"},
        "food_18": {"name": "푸드트럭 18", "description": "추후 안내해 드리겠습니다.", "image_url": "/static/images/hotdog.jpg"},
        "food_19": {"name": "푸드트럭 19", "description": "추후 안내해 드리겠습니다.", "image_url": "/static/images/hotdog.jpg"},
        "food_20": {"name": "푸드트럭 20", "description": "추후 안내해 드리겠습니다.", "image_url": "/static/images/hotdog.jpg"},
        # 다른 부스들 추가
    }
